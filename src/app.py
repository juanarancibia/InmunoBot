...
st.title("InmunoBot")
st.markdown("#### Tu Asistente Inteligente de Inmunología")

# st write magic
"""

InmunoBot es un chatbot diseñado para estudiantes de la cátedra de Inmunología de la UBA. 
Basado en la bibliografía del curso, responde tus preguntas, aclara conceptos clave y 
facilita tu estudio de la inmunología de manera rápida y eficiente.
...
if "messages" not in st.session_state:
    ...
    st.session_state["messages"] = [AIMessage(content="En que te puedo ayudar hoy?")]
